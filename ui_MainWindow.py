...
"}")
        ...
        self.backup_all.setGeometry(QRect(20, 220, 559, 90))
        ...
        self.add_item.setGeometry(QRect(20, 20, 559, 90))
        ...
        self.remove_item.setGeometry(QRect(20, 120, 559, 90))
        ...
        self.restore_all.setGeometry(QRect(20, 320, 559, 90))
...
"border-radius: 20px;")
        ...
        self.restore_selected = QPushButton(self.centralwidget)
        self.restore_selected.setObjectName(u"restore_selected")
        self.restore_selected.setEnabled(True)
        self.restore_selected.setGeometry(QRect(20, 520, 559, 90))
        ...
        icon4 = QIcon()
        icon4.addFile(u":/icons/icons/restore_selected.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.restore_selected.setIcon(icon4)
        self.restore_selected.setIconSize(QSize(110, 110))
        self.backup_selected = QPushButton(self.centralwidget)
        self.backup_selected.setObjectName(u"backup_selected")
        self.backup_selected.setEnabled(True)
        self.backup_selected.setGeometry(QRect(20, 420, 559, 90))
        ...
        icon5 = QIcon()
        icon5.addFile(u":/icons/icons/backup_selected.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.backup_selected.setIcon(icon5)
