...
"}")
        ...
        self.layoutWidget.setGeometry(QRect(20, -10, 564, 803))
        ...
        icon = QIcon()
        icon.addFile(u":/icons/icons/add_item.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon1 = QIcon()
        icon1.addFile(u":/icons/icons/remove_item.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.remove_item.setIcon(icon1)
        self.remove_item.setIconSize(QSize(72, 72))

        self.verticalLayout_2.addWidget(self.remove_item)
        ...
        icon2 = QIcon()
        icon2.addFile(u":/icons/icons/safe_in_all.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.backup_all.setIcon(icon2)
        self.backup_all.setIconSize(QSize(115, 115))

        self.verticalLayout_2.addWidget(self.backup_all)
        ...
        self.verticalLayout_2.addWidget(self.restore_all)
        ...
        icon4 = QIcon()
        icon4.addFile(u":/icons/icons/backup_selected.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.backup_selected.setIcon(icon4)
        self.backup_selected.setIconSize(QSize(115, 115))

        self.verticalLayout_2.addWidget(self.backup_selected)
        ...
        icon5 = QIcon()
        icon5.addFile(u":/icons/icons/restore_selected.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.restore_selected.setIcon(icon5)
        self.restore_selected.setIconSize(QSize(110, 110))

        self.verticalLayout_2.addWidget(self.restore_selected)
        ...
        self.settings.setIconSize(QSize(65, 65))
        ...
        icon7 = QIcon()
        icon7.addFile(u":/icons/icons/exit.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.exit.setIcon(icon7)
        self.exit.setIconSize(QSize(90, 90))
