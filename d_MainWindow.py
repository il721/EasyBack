...
class UiMainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(390, 520)
        MainWindow.setMaximumSize(QSize(390, 520))
        ...
        self.centralwidget.setMinimumSize(QSize(390, 520))
        self.centralwidget.setMaximumSize(QSize(390, 520))
        self.centralwidget.setStyleSheet(u"")
        self.layoutWidget = QWidget(self.centralwidget)
        self.layoutWidget.setObjectName(u"layoutWidget")
        self.layoutWidget.setGeometry(QRect(14, 7, 365, 496))
